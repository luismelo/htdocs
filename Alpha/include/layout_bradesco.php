...
<meta name="Generator" content="Boleto do aluno" />
<style type=text/css>
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><IMG SRC="imagens/sequencial_login_icon.jpg"></td>
...
Outras deduõeses</td><td class=ct valign=top width=7 height=13><img height=13 src=imagens/1.png width=1 border=0></td><td class=ct valign=top width=113 height=13>(+) 
