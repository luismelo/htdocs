...
/**
 * Strings for component 'error', language 'pt_br', branch 'MOODLE_30_STABLE'
 *
 * @package   error
...
$string['sessionerroruser'] = 'A sua sessão foi interrompida (time out). Por favor, faça login novamente.';
